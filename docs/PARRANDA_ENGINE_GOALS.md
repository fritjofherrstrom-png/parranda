...
and every Live scope query, and a recurring entry may claim only the days its
source states. See `LIVE_SELECTED_DATE.md` for the selected-day contract,
recurring-entry semantics and bounded recall limitations. Bounded acquisition
budgets must serve the requested period first: trusted venue lookups prioritize
