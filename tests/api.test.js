...
test("GET /barcelona avslöjar fallback i app shell bootstrap innan stad 2 finns", async () => {
  ...
  try {
    ...
    assert.match(response.body, /<p id="heroEyebrow" class="hero-kicker">BARCELONA · PREVIEW<\/p>/);
...
test("GET /test-city renderar en egen city shell utan Rome-fallback", async () => {
  ...
  try {
    ...
    assert.match(response.body, /<p id="heroEyebrow" class="hero-kicker">TEST CITY · INTERN PREVIEW<\/p>/);
