...
function buildShellCopy(shellMode, options = {}) {
  ...
  return {
    ...
    plannerCtaLabel: "Låt Parranda planera",
    plannerMicrocopy: "Du kan alltid styra mer exakt i nästa steg.",
    wildcardLabel: "BLITZ",
    wildcardTitle: "Laddar nästa drag...",
    wildcardSummary: "När du redan är ute i staden väljer Blitz vad som känns starkast just nu.",
    wildcardMeta: "Plats • tid • Pulse • availability.",
    wildcardTag1: "Nu",
    wildcardTag2: "Plats",
    wildcardTag3: "Reroll",
